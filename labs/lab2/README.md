...
## Variant
J=13: static array N=113, solid **red** rubber band (13 mod 4 = 1),
rectangle — input **from center to corner**, **no fill** (13 mod 5 = 3);
ellipse — input **by two corners**, **yellow fill** (13 mod 6 = 1);
type indicator **in window title** (13 mod 2 = 1).
