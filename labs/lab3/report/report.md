...
_Рис. 1. Головне вікно: панель інструментів з 7 кнопками-іконками
(точка, лінія, прямокутник, еліпс, трикутник, вибір, губка).
Підказки кнопок надходять через `WM_NOTIFY`/`TTN_NEEDTEXT`_

### Намальовані об'єкти

<img src="screenshots/shapes_all.png" style="width: 100%; max-width: 800px;">

_Рис. 2. Об'єкти різних типів на канвасі: точки, лінії, трикутники,
прямокутник. Заливку прямокутника змінено на синій, трикутника — на
зелений (діалог ChooseColor); виділений об'єкт обведено червоною
пунктирною рамкою_
...
_Рис. 3. Інструмент «Вибір»: клік по об'єкту обводить його
червоною пунктирною рамкою (`DrawSelection`, `PS_DASH`)_

### Зміна кольору заповнення

<img src="screenshots/select_color.png" style="width: 100%; max-width: 800px;">

_Рис. 4. Діалог `ChooseColor` над виділеним об'єктом — новий колір
заповнення застосовується одразу після OK_

### Губка — видалення об'єктів

<img src="screenshots/eraser_before.png" style="width: 100%; max-width: 700px;">
<img src="screenshots/eraser.png" style="width: 100%; max-width: 700px;">

_Рис. 5. Губка: два трикутники накладені один на одного →
після проходу губкою верхній видалено повністю (HitTest згори-вниз)_
